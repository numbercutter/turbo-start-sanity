(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_next_dist_compiled_react-dom-experimental_375bf58e._.js", {

"[project]/node_modules/next/dist/compiled/react-dom-experimental/cjs/react-dom.development.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/next/dist/compiled/react-dom-experimental/index.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/next/dist/compiled/react-dom-experimental/cjs/react-dom-client.development.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function startUpdateTimerByLane(lane) {
        ...
        if (JSCompiler_temp) 0 > blockingUpdateTime && (blockingUpdateTime = now(), (executionContext & (RenderContext | CommitContext)) !== NoContext && (blockingSpawnedUpdate = !0), lane = resolveEventTimeStamp(), JSCompiler_temp = resolveEventType(), lane !== blockingEventTime || JSCompiler_temp !== blockingEventType ? blockingEventIsRepeat = !1 : null !== JSCompiler_temp && (blockingSpawnedUpdate = !0), blockingEventTime = lane, blockingEventType = JSCompiler_temp);
        else if (0 !== (lane & 4194048) && 0 > transitionUpdateTime && (transitionUpdateTime = now(), 0 > transitionStartTime)) {
            lane = resolveEventTimeStamp();
            JSCompiler_temp = resolveEventType();
            if (lane !== transitionEventTime || JSCompiler_temp !== transitionEventType) transitionEventIsRepeat = !1;
    ...
    function setCurrentTrackFromLanes(lanes) {
        reusableLaneDevToolDetails.track = lanes & 127 ? "Blocking" : lanes & 4194176 ? "Transition" : lanes & 62914560 ? "Suspense" : lanes & 2080374784 ? "Idle" : "Other";
    }
    function logComponentRender(fiber, startTime, endTime, wasHydrated) {
        var name = getComponentNameFromFiber(fiber);
        if (null !== name && supportsUserTiming) {
            var selfTime = fiber.actualDuration;
            if (null === fiber.alternate || fiber.alternate.child !== fiber.child) for(fiber = fiber.child; null !== fiber; fiber = fiber.sibling)selfTime -= fiber.actualDuration;
    ...
    function logComponentEffect(fiber, startTime, endTime, selfTime, errors) {
        ...
        } else errors = getComponentNameFromFiber(fiber), null !== errors && supportsUserTiming && (reusableComponentDevToolDetails.color = 1 > selfTime ? "secondary-light" : 100 > selfTime ? "secondary" : 500 > selfTime ? "secondary-dark" : "error", reusableComponentOptions.start = startTime, reusableComponentOptions.end = endTime, performance.measure(errors, reusableComponentOptions));
    }
    function logRenderPhase(startTime, endTime, lanes) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197653) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure((lanes & 536870912) === lanes ? "Prepared" : (lanes & 201326741) === lanes ? "Hydrated" : "Render", reusableLaneOptions));
    }
    function logSuspendedRenderPhase(startTime, endTime, lanes) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197653) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure("Prewarm", reusableLaneOptions));
    }
    function logSuspendedWithDelayPhase(startTime, endTime, lanes) {
        supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197653) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure("Suspended", reusableLaneOptions));
    }
    ...
    function scheduleGesture(root, provider, initialDirection, rangePrevious, rangeCurrent, rangeNext) {
        ...
        next = subscribeToGestureDirection(provider, rangeCurrent, function(direction) {
            isFlippedDirection && (direction = !direction);
            gesture.direction !== direction && (gesture.direction = direction, null === gesture.prev && root.pendingGestures !== gesture && (direction = root.pendingGestures, gesture.next = direction, null !== direction && (direction.prev = gesture), root.pendingGestures = gesture, root.pendingLanes |= 64, ensureRootIsScheduled(root)));
        });
        var gesture = {
            provider: provider,
            count: 1,
    ...
    function deleteScheduledGesture(root, gesture) {
        null === gesture.prev ? (root.pendingGestures === gesture && (root.pendingGestures = gesture.next, null === root.pendingGestures && (root.pendingLanes &= -65)), root.stoppingGestures === gesture && (root.stoppingGestures = gesture.next)) : (gesture.prev.next = gesture.next, null !== gesture.next && (gesture.next.prev = gesture.prev), gesture.prev = null, gesture.next = null);
    }
    function stopCompletedGestures(root) {
        var gesture = root.stoppingGestures;
        for(root.stoppingGestures = null; null !== gesture;)null !== gesture.running && (gesture.running.skipTransition(), gesture.running = null), root = gesture.next, gesture.next = null, gesture.prev = null, gesture = root;
    }
    ...
    function mountId() {
        ...
        if (isHydrating) {
            ...
            identifierPrefix += "\u00bb";
        } else treeId = globalClientIdCounter$1++, identifierPrefix = "\u00ab" + identifierPrefix + "r" + treeId.toString(32) + "\u00bb";
        ...
        for(var provider = fiber.return; null !== provider;){
            switch(provider.tag){
                ...
                case 3:
                    ...
                    null !== root && (startUpdateTimerByLane(lane), scheduleUpdateOnFiber(root, provider, lane), entangleTransitions(root, provider, lane));
                    provider = createCache();
                    null !== seedKey && void 0 !== seedKey && null !== root && provider.data.set(seedKey, seedValue);
                    fiber.payload = {
                        cache: provider
                    };
                    return;
    ...
    function dispatchOptimisticSetState(fiber, throwIfDuringRender, queue, action) {
        ...
        } else throwIfDuringRender = enqueueConcurrentHookUpdate(fiber, queue, action, 2), null !== throwIfDuringRender && (startUpdateTimerByLane(2), scheduleUpdateOnFiber(throwIfDuringRender, fiber, 2));
    }
    ...
    function startGesture(fiber, queue, gestureProvider, gestureOptions) {
        ...
        var range = gestureOptions && gestureOptions.range, rangePrevious = range ? range[0] : 0, rangeCurrent = range ? range[1] : fiber;
        range = range ? range[2] : 100;
        (rangePrevious > rangeCurrent && range > rangeCurrent || rangePrevious < rangeCurrent && range < rangeCurrent) && console.error('The range of a gesture needs "previous" and "next" to be on either side of the "current" offset. Both cannot be above current and both cannot be below current.');
        var isFlippedDirection = rangePrevious > range, update = {
            gesture: scheduleGesture(root, gestureProvider, fiber < rangeCurrent ? isFlippedDirection : fiber > rangeCurrent ? !isFlippedDirection : gestureOptions && "next" === gestureOptions.direction ? !0 : gestureOptions && "previous" === gestureOptions.direction ? !1 : queue.initialDirection, rangePrevious, rangeCurrent, range),
            prev: null,
            next: queue.pending
        };
        ...
        queue.pending = update;
        return function() {
            if (null === update.prev) if (queue.pending === update) queue.pending = update.next;
            else return;
            else update.prev.next = update.next, null !== update.next && (update.next.prev = update.prev), update.prev = null, update.next = null;
            ...
            if (0 === gesture.count) {
                ...
                if (null !== cancelDirectionSubscription) {
                    ...
                    0 !== (pendingLanesExcludingGestureLane & 124) || 0 !== (pendingLanesExcludingGestureLane & 4194048) ? (cancelDirectionSubscription = root.stoppingGestures, null !== cancelDirectionSubscription && (gesture.next = cancelDirectionSubscription, cancelDirectionSubscription.prev = gesture), root.stoppingGestures = gesture) : (gesture.running = null, cancelDirectionSubscription.skipTransition());
                }
            }
        };
    }
    function mountSwipeTransition(previous, current) {
        ...
        var startGestureOnHook = previous.dispatch = startGesture.bind(null, currentlyRenderingFiber, previous);
    ...
    function updateSwipeTransition(previous, current, next) {
        var queue = updateWorkInProgressHook().queue, startGestureOnHook = queue.dispatch, rootRenderLanes = workInProgressRootRenderLanes, value = current;
        if (null !== queue.pending) {
            if (64 === rootRenderLanes) {
                rootRenderLanes = workInProgressRoot;
                if (null === rootRenderLanes) throw Error("Expected a work-in-progress root. This is a bug in React. Please file an issue.");
                rootRenderLanes = rootRenderLanes.pendingGestures;
                if (null !== rootRenderLanes) for(var update = queue.pending; null !== update;){
    ...
    function createChildReconciler(shouldTrackSideEffects) {
        ...
        function updateFromMap(existingChildren, returnFiber, newIdx, newChild, lanes) {
            ...
            if ("object" === typeof newChild && null !== newChild) {
                ...
                if (isArrayImpl(newChild) || getIteratorFn(newChild) || "function" === typeof newChild[ASYNC_ITERATOR]) return newIdx = existingChildren.get(newIdx) || null, existingChildren = pushDebugInfo(newChild._debugInfo), returnFiber = updateFragment(returnFiber, newIdx, newChild, lanes, null), currentDebugInfo = existingChildren, returnFiber;
        ...
        function reconcileChildFibersImpl(returnFiber, currentFirstChild, newChild, lanes) {
            ...
            if ("object" === typeof newChild && null !== newChild) {
                ...
                if ("function" === typeof newChild[ASYNC_ITERATOR]) return prevDebugInfo = pushDebugInfo(newChild._debugInfo), returnFiber = reconcileChildrenAsyncIteratable(returnFiber, currentFirstChild, newChild, lanes), currentDebugInfo = prevDebugInfo, returnFiber;
    ...
    function throwException(root, returnFiber, sourceFiber, value, rootRenderLanes) {
        ...
        if (null !== value && "object" === typeof value && (value.$$typeof === REACT_POSTPONE_TYPE && (value = {
            then: function() {}
        ...
        queueConcurrentError(createCapturedValueAtFiber(Error("There was an error during concurrent rendering but React was able to recover by instead synchronously rendering the entire root.", {
            cause: value
        }), sourceFiber));
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        (JSCompiler_object_inline_componentStack_2757 = didSuspend) || (JSCompiler_object_inline_componentStack_2757 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_componentStack_2757 && (JSCompiler_object_inline_message_2754 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_componentStack_2757 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_message_2754 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                if (isHydrating) {
                    ...
                    JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_digest_2755), throwOnHydrationMismatch(workInProgress));
                }
                JSCompiler_object_inline_digest_2755 = workInProgress.memoizedState;
                if (null !== JSCompiler_object_inline_digest_2755 && (JSCompiler_object_inline_digest_2755 = JSCompiler_object_inline_digest_2755.dehydrated, null !== JSCompiler_object_inline_digest_2755)) return isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2755) ? workInProgress.lanes = 32 : workInProgress.lanes = 536870912, null;
                popSuspenseHandler(workInProgress);
            }
            JSCompiler_object_inline_digest_2755 = JSCompiler_object_inline_stack_2756.children;
            JSCompiler_temp = JSCompiler_object_inline_stack_2756.fallback;
            if (JSCompiler_object_inline_message_2754) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2756 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2755, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2754 = workInProgress.child, JSCompiler_object_inline_message_2754.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2754.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2757, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2756;
            if ("number" === typeof JSCompiler_object_inline_stack_2756.unstable_expectedLoadTime) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2756 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2755, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2754 = workInProgress.child, JSCompiler_object_inline_message_2754.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2754.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2757, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress.lanes = 4194304, JSCompiler_object_inline_stack_2756;
            pushPrimaryTreeSuspenseHandler(workInProgress);
            return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_digest_2755);
        }
        var prevState = current.memoizedState;
        if (null !== prevState && (JSCompiler_object_inline_digest_2755 = prevState.dehydrated, null !== JSCompiler_object_inline_digest_2755)) {
            if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2754 = JSCompiler_object_inline_stack_2756.fallback, JSCompiler_object_inline_digest_2755 = workInProgress.mode, JSCompiler_object_inline_stack_2756 = mountWorkInProgressOffscreenFiber({
                mode: "visible",
                children: JSCompiler_object_inline_stack_2756.children
            }, JSCompiler_object_inline_digest_2755), JSCompiler_object_inline_message_2754 = createFiberFromFragment(JSCompiler_object_inline_message_2754, JSCompiler_object_inline_digest_2755, renderLanes, null), JSCompiler_object_inline_message_2754.flags |= 2, JSCompiler_object_inline_stack_2756.return = workInProgress, JSCompiler_object_inline_message_2754.return = workInProgress, JSCompiler_object_inline_stack_2756.sibling = JSCompiler_object_inline_message_2754, workInProgress.child = JSCompiler_object_inline_stack_2756, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2756 = workInProgress.child, JSCompiler_object_inline_stack_2756.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2756.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2757, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_message_2754);
            else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2755)) {
                JSCompiler_object_inline_componentStack_2757 = JSCompiler_object_inline_digest_2755.nextSibling && JSCompiler_object_inline_digest_2755.nextSibling.dataset;
                if (JSCompiler_object_inline_componentStack_2757) {
                    ...
                    var componentStack = JSCompiler_object_inline_componentStack_2757.cstck;
                }
                ...
                JSCompiler_temp = JSCompiler_object_inline_componentStack_2757 = componentStack;
                "POSTPONE" !== JSCompiler_object_inline_digest_2755 && (JSCompiler_object_inline_componentStack_2757 = JSCompiler_object_inline_message_2754 ? Error(JSCompiler_object_inline_message_2754) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."), JSCompiler_object_inline_componentStack_2757.stack = JSCompiler_object_inline_stack_2756 || "", JSCompiler_object_inline_componentStack_2757.digest = JSCompiler_object_inline_digest_2755, JSCompiler_object_inline_stack_2756 = void 0 === JSCompiler_temp ? null : JSCompiler_temp, JSCompiler_object_inline_message_2754 = {
                    value: JSCompiler_object_inline_componentStack_2757,
                    source: null,
                    stack: JSCompiler_object_inline_stack_2756
                }, "string" === typeof JSCompiler_object_inline_stack_2756 && CapturedStacks.set(JSCompiler_object_inline_componentStack_2757, JSCompiler_object_inline_message_2754), queueHydrationError(JSCompiler_object_inline_message_2754));
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_componentStack_2757 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_componentStack_2757) {
                JSCompiler_object_inline_componentStack_2757 = workInProgressRoot;
                if (null !== JSCompiler_object_inline_componentStack_2757 && (JSCompiler_object_inline_stack_2756 = renderLanes & -renderLanes, JSCompiler_object_inline_stack_2756 = 0 !== (JSCompiler_object_inline_stack_2756 & 42) ? 1 : getBumpedLaneForHydrationByLane(JSCompiler_object_inline_stack_2756), JSCompiler_object_inline_stack_2756 = 0 !== (JSCompiler_object_inline_stack_2756 & (JSCompiler_object_inline_componentStack_2757.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2756, 0 !== JSCompiler_object_inline_stack_2756 && JSCompiler_object_inline_stack_2756 !== prevState.retryLane)) throw prevState.retryLane = JSCompiler_object_inline_stack_2756, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2756), scheduleUpdateOnFiber(JSCompiler_object_inline_componentStack_2757, current, JSCompiler_object_inline_stack_2756), SelectiveHydrationException;
                JSCompiler_object_inline_digest_2755.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else JSCompiler_object_inline_digest_2755.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 192, workInProgress.child = current.child, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_digest_2755.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2756.children), workInProgress.flags |= 4096);
            return workInProgress;
        }
        if (JSCompiler_object_inline_message_2754) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2754 = JSCompiler_object_inline_stack_2756.fallback, JSCompiler_object_inline_digest_2755 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2756 = createWorkInProgress(JSCompiler_temp, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2756.children
        }), JSCompiler_object_inline_stack_2756.subtreeFlags = JSCompiler_temp.subtreeFlags & 65011712, null !== instance ? JSCompiler_object_inline_message_2754 = createWorkInProgress(instance, JSCompiler_object_inline_message_2754) : (JSCompiler_object_inline_message_2754 = createFiberFromFragment(JSCompiler_object_inline_message_2754, JSCompiler_object_inline_digest_2755, renderLanes, null), JSCompiler_object_inline_message_2754.flags |= 2), JSCompiler_object_inline_message_2754.return = workInProgress, JSCompiler_object_inline_stack_2756.return = workInProgress, JSCompiler_object_inline_stack_2756.sibling = JSCompiler_object_inline_message_2754, workInProgress.child = JSCompiler_object_inline_stack_2756, JSCompiler_object_inline_stack_2756 = JSCompiler_object_inline_message_2754, JSCompiler_object_inline_message_2754 = workInProgress.child, JSCompiler_object_inline_digest_2755 = current.child.memoizedState, null === JSCompiler_object_inline_digest_2755 ? JSCompiler_object_inline_digest_2755 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_digest_2755.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
            parent: instance,
            pool: instance
        } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_digest_2755 = {
            baseLanes: JSCompiler_object_inline_digest_2755.baseLanes | renderLanes,
            cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_message_2754.memoizedState = JSCompiler_object_inline_digest_2755, JSCompiler_object_inline_message_2754.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2757, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2756;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_componentStack_2757 = workInProgress.deletions, null === JSCompiler_object_inline_componentStack_2757 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_componentStack_2757.push(current));
    ...
    function insertOrAppendPlacementNode(node, before, parent) {
        var tag = node.tag;
        if (5 === tag || 6 === tag) node = node.stateNode, before ? parent.insertBefore(node, before) : parent.appendChild(node), viewTransitionMutationContext = !0;
    ...
    function applyViewTransitionToHostInstances(child, name, className, collectMeasurements, stopAtNestedViewTransitions) {
        for(var inViewport = !1; null !== child;){
            ...
            } else if (22 !== child.tag || null === child.memoizedState) 30 === child.tag && stopAtNestedViewTransitions || applyViewTransitionToHostInstances(child.child, name, className, collectMeasurements, stopAtNestedViewTransitions) && (inViewport = !0);
            child = child.sibling;
        }
        return inViewport;
    }
        ...
        if (0 !== (placement.subtreeFlags & 18874368)) for(placement = placement.child; null !== placement;){
            if (22 !== placement.tag || null !== placement.memoizedState) {
                if (commitAppearingPairViewTransitions(placement), 30 === placement.tag && 0 !== (placement.flags & 18874368) && placement.stateNode.paired) {
                    ...
                    "none" !== props && (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(placement.child, name, props, null, !1) || restoreViewTransitionOnHostInstances(placement.child, !1));
                }
            }
    ...
    function commitEnterViewTransitions(placement) {
        if (30 === placement.tag) {
            var state = placement.stateNode, props = placement.memoizedProps, name = getViewTransitionName(props, state), className = getViewTransitionClassName(props.className, state.paired ? props.share : props.enter);
            "none" !== className ? (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(placement.child, name, className, null, !1) ? (commitAppearingPairViewTransitions(placement), state.paired || scheduleViewTransitionEvent(placement, props.onEnter)) : restoreViewTransitionOnHostInstances(placement.child, !1)) : commitAppearingPairViewTransitions(placement);
        } else if (0 !== (placement.subtreeFlags & 33554432)) for(placement = placement.child; null !== placement;)commitEnterViewTransitions(placement), placement = placement.sibling;
                ...
                if (22 !== deletion.tag || null !== deletion.memoizedState) {
                    if (30 === deletion.tag && 0 !== (deletion.flags & 18874368)) {
                        ...
                        if (null != name && "auto" !== name) {
                            ...
                            if (void 0 !== pair) {
                                var className = getViewTransitionClassName(props.className, props.share);
                                "none" !== className && (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(deletion.child, name, className, null, !1) ? (pair.paired = deletion.stateNode, scheduleViewTransitionEvent(deletion, props.onShare)) : restoreViewTransitionOnHostInstances(deletion.child, !1));
                                pairs.delete(name);
    ...
    function commitExitViewTransitions(deletion) {
        if (30 === deletion.tag) {
            var props = deletion.memoizedProps, name = getViewTransitionName(props, deletion.stateNode), pair = null !== appearingViewTransitions ? appearingViewTransitions.get(name) : void 0, className = getViewTransitionClassName(props.className, void 0 !== pair ? props.share : props.exit);
            "none" !== className && (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(deletion.child, name, className, null, !1) ? void 0 !== pair ? (pair.paired = deletion.stateNode, appearingViewTransitions.delete(name), scheduleViewTransitionEvent(deletion, props.onShare)) : scheduleViewTransitionEvent(deletion, props.onExit) : restoreViewTransitionOnHostInstances(deletion.child, !1));
    ...
    function commitNestedViewTransitions(changedParent) {
        for(changedParent = changedParent.child; null !== changedParent;){
            if (30 === changedParent.tag) {
                ...
                "none" !== props && (viewTransitionHostInstanceIdx = 0, applyViewTransitionToHostInstances(changedParent.child, name, props, changedParent.memoizedState = [], !1));
    ...
    function restoreEnterViewTransitions(placement) {
        if (30 === placement.tag) placement.stateNode.paired = null, restoreViewTransitionOnHostInstances(placement.child, !1), restorePairedViewTransitions(placement);
        else if (0 !== (placement.subtreeFlags & 33554432)) for(placement = placement.child; null !== placement;)restoreEnterViewTransitions(placement), placement = placement.sibling;
        else restorePairedViewTransitions(placement);
    }
    function restoreExitViewTransitions(deletion) {
        if (30 === deletion.tag) deletion.stateNode.paired = null, restoreViewTransitionOnHostInstances(deletion.child, !1), restorePairedViewTransitions(deletion);
        else if (0 !== (deletion.subtreeFlags & 33554432)) for(deletion = deletion.child; null !== deletion;)restoreExitViewTransitions(deletion), deletion = deletion.sibling;
        else restorePairedViewTransitions(deletion);
    }
    function restoreNestedViewTransitions(changedParent) {
        for(changedParent = changedParent.child; null !== changedParent;)30 === changedParent.tag ? (changedParent.memoizedState = null, restoreViewTransitionOnHostInstances(changedParent.child, !1)) : 0 !== (changedParent.subtreeFlags & 33554432) && restoreNestedViewTransitions(changedParent), changedParent = changedParent.sibling;
    }
    function cancelViewTransitionHostInstances(currentViewTransition, child, stopAtNestedViewTransitions) {
        for(; null !== child;){
            if (5 === child.tag) {
                var instance = child.stateNode, oldName = getViewTransitionName(currentViewTransition.memoizedProps, currentViewTransition.stateNode);
                ...
                viewTransitionHostInstanceIdx++;
            } else if (22 !== child.tag || null === child.memoizedState) 30 === child.tag && stopAtNestedViewTransitions || cancelViewTransitionHostInstances(currentViewTransition, child.child, stopAtNestedViewTransitions);
            child = child.sibling;
        }
    }
    function measureViewTransitionHostInstances(currentViewTransition, parentViewTransition, child, name, className, previousMeasurements, stopAtNestedViewTransitions) {
        for(var inViewport = !1; null !== child;){
            if (5 === child.tag) {
                ...
                inViewport && 0 !== (parentViewTransition.flags & 4) || (nextMeasurement = getViewTransitionName(currentViewTransition.memoizedProps, currentViewTransition.stateNode), null === viewTransitionCancelableChildren && (viewTransitionCancelableChildren = []), viewTransitionCancelableChildren.push(instance, nextMeasurement, child.memoizedProps));
                viewTransitionHostInstanceIdx++;
            } else if (22 !== child.tag || null === child.memoizedState) 30 === child.tag && stopAtNestedViewTransitions ? parentViewTransition.flags |= child.flags & 32 : measureViewTransitionHostInstances(currentViewTransition, parentViewTransition, child.child, name, className, previousMeasurements, stopAtNestedViewTransitions) && (inViewport = !0);
            child = child.sibling;
        }
        return inViewport;
    }
    function measureNestedViewTransitions(changedParent) {
        for(changedParent = changedParent.child; null !== changedParent;){
            if (30 === changedParent.tag) {
                ...
                if (null !== current) {
                    var props = changedParent.memoizedProps, name = getViewTransitionName(props, changedParent.stateNode), className = getViewTransitionClassName(props.className, props.layout);
                    viewTransitionHostInstanceIdx = 0;
                    current = measureViewTransitionHostInstances(current, changedParent, changedParent.child, name, className, changedParent.memoizedState, !1);
                    0 !== (changedParent.flags & 4) && current && scheduleViewTransitionEvent(changedParent, props.onLayout);
                }
            } else 0 !== (changedParent.subtreeFlags & 33554432) && measureNestedViewTransitions(changedParent);
            changedParent = changedParent.sibling;
        }
    }
    function commitBeforeMutationEffects(root, firstChild, committedLanes) {
        ...
        for(firstChild = committedLanes ? 9238 : 1028; null !== nextEffect;){
            ...
            if (null === root.alternate && 0 !== (root.flags & 2)) commitBeforeMutationEffects_complete(committedLanes);
            else {
                if (22 === root.tag) {
        ...
        for(; null !== nextEffect;){
            ...
            switch(finishedWork.tag){
                ...
                case 17:
                    break;
                case 30:
                    if (isViewTransitionEligible && null !== current && 0 !== (finishedWork.subtreeFlags & 8246)) a: {
                        isViewTransitionEligible = current;
                        current = finishedWork;
                        finishedWork = getViewTransitionName(isViewTransitionEligible.memoizedProps, isViewTransitionEligible.stateNode);
                        current = current.memoizedProps;
                        flags = getViewTransitionClassName(current.className, current.update);
                        if ("none" === flags && (flags = getViewTransitionClassName(current.className, current.layout), "none" === flags)) break a;
                        viewTransitionHostInstanceIdx = 0;
                        applyViewTransitionToHostInstances(isViewTransitionEligible.child, finishedWork, flags, isViewTransitionEligible.memoizedState = [], !0);
                    }
                    break;
                default:
    ...
    function commitLayoutEffectOnFiber(finishedRoot, current, finishedWork) {
        ...
        (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && 0.05 < componentEffectDuration && logComponentEffect(finishedWork, componentEffectStartTime, componentEffectEndTime, componentEffectDuration, componentEffectErrors);
    ...
    function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber, lanes) {
        ...
        if (parentFiber.subtreeFlags & 13878) for(parentFiber = parentFiber.child; null !== parentFiber;)commitMutationEffectsOnFiber(parentFiber, root$jscomp$0, lanes), parentFiber = parentFiber.sibling;
    }
    function commitMutationEffectsOnFiber(finishedWork, root, lanes) {
        var prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors(), current = finishedWork.alternate, flags = finishedWork.flags;
        switch(finishedWork.tag){
            case 0:
            case 11:
            case 14:
            ...
            case 1:
                ...
                flags & 64 && offscreenSubtreeIsHidden && (current = finishedWork.updateQueue, null !== current && (flags = current.callbacks, null !== flags && (root = current.shared.hiddenCallbacks, current.shared.hiddenCallbacks = null === root ? flags : root.concat(flags))));
                break;
            case 26:
                    ...
                    a: {
                        ...
                        b: switch(current){
                            case "title":
                                ...
                                if (!lanes || lanes[internalHoistableMarker] || lanes[internalInstanceKey] || lanes.namespaceURI === SVG_NAMESPACE || lanes.hasAttribute("itemprop")) lanes = root.createElement(current), root.head.insertBefore(lanes, root.querySelector("head > title"));
                            ...
                            case "link":
                                ...
                                break;
                            case "meta":
                                if (hoistableRoot = getHydratableHoistableCache("meta", "content", root).get(current + (flags.content || ""))) {
            ...
            case 6:
                ...
                if (flags & 4) {
                    ...
                    root = finishedWork.stateNode;
                    try {
                        runWithFiberInDEV(finishedWork, commitTextUpdate, root, current, flags), viewTransitionMutationContext = !0;
                    } catch (error) {
                        captureCommitPhaseError(finishedWork, finishedWork.return, error);
                    }
                }
            ...
            case 22:
                ...
                if (flags & 8192 && (root._visibility = hoistableRoot ? root._visibility & ~OffscreenVisible : root._visibility | OffscreenVisible, hoistableRoot && (null === current || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || recursivelyTraverseDisappearLayoutEffects(finishedWork)), null === finishedWork.memoizedProps || "manual" !== finishedWork.memoizedProps.mode)) a: for(current = null, root = finishedWork;;){
                    if (5 === root.tag || 26 === root.tag) {
                        if (null === current) {
                            lanes = current = root;
                            try {
                                i = lanes.stateNode, hoistableRoot ? runWithFiberInDEV(lanes, hideInstance, i) : runWithFiberInDEV(lanes, unhideInstance, lanes.stateNode, lanes.memoizedProps);
                            } catch (error) {
                        ...
                        if (null === current) {
                            ...
                            try {
                                ...
                                hoistableRoot ? runWithFiberInDEV(lanes, hideTextInstance, instance) : runWithFiberInDEV(lanes, unhideTextInstance, instance, lanes.memoizedProps);
                            } catch (error) {
                                captureCommitPhaseError(lanes, lanes.return, error);
                            }
                        }
                ...
                flags & 4 && (current = finishedWork.updateQueue, null !== current && (flags = current.retryQueue, null !== flags && (current.retryQueue = null, attachSuspenseRetryListeners(finishedWork, flags))));
                break;
            case 19:
                recursivelyTraverseMutationEffects(root, finishedWork, lanes);
                commitReconciliationEffects(finishedWork);
            ...
            case 30:
                ...
                recursivelyTraverseMutationEffects(root, finishedWork, lanes);
                commitReconciliationEffects(finishedWork);
                (lanes & 335544064) === lanes && null !== current && viewTransitionMutationContext && (finishedWork.flags |= 4);
    ...
    function recursivelyTraverseAfterMutationEffects(root, parentFiber) {
        if (parentFiber.subtreeFlags & 9238) for(parentFiber = parentFiber.child; null !== parentFiber;)commitAfterMutationEffectsOnFiber(parentFiber, root), parentFiber = parentFiber.sibling;
    ...
    function commitAfterMutationEffectsOnFiber(finishedWork, root) {
        ...
        if (null === current) commitEnterViewTransitions(finishedWork);
            ...
            case 5:
                ...
                break;
            case 22:
                null === finishedWork.memoizedState && (null !== current.memoizedState ? commitEnterViewTransitions(finishedWork) : recursivelyTraverseAfterMutationEffects(root, finishedWork));
                break;
            case 30:
                if (0 !== (finishedWork.subtreeFlags & 8246)) {
                    ...
                    a: {
                        ...
                        var updateClassName = getViewTransitionClassName(root.className, root.update), layoutClassName = getViewTransitionClassName(root.className, root.layout);
                        if ("none" === updateClassName) {
                            ...
                            if ("none" === layoutClassName) {
                                viewTransitionHostInstanceIdx = 0;
                                cancelViewTransitionHostInstances(current, finishedWork.child, !0);
                                current = !1;
                                break a;
                            }
                            updateClassName = layoutClassName;
                        }
                        layoutClassName = getViewTransitionName(root, finishedWork.stateNode);
                        viewTransitionHostInstanceIdx = 0;
                        root = current.memoizedState;
                        current = measureViewTransitionHostInstances(current, finishedWork, finishedWork.child, layoutClassName, updateClassName, root, !0);
                        viewTransitionHostInstanceIdx !== (null === root ? 0 : root.length) && (finishedWork.flags |= 32);
                    }
                    0 !== (finishedWork.flags & 4) && current ? (current = finishedWork.memoizedProps, scheduleViewTransitionEvent(finishedWork, i || viewTransitionContextChanged ? current.onUpdate : current.onLayout), viewTransitionCancelableChildren = instance) : null !== instance && (instance.push.apply(instance, viewTransitionCancelableChildren), viewTransitionCancelableChildren = instance);
                    viewTransitionContextChanged = 0 !== (finishedWork.flags & 32) ? !0 : oldName;
                }
                break;
            default:
                recursivelyTraverseAfterMutationEffects(root, finishedWork);
    ...
    function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) {
        var prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors();
        (finishedWork.mode & ProfileMode) !== NoMode && 0 < finishedWork.actualStartTime && 0 !== (finishedWork.flags & 1) && logComponentRender(finishedWork, finishedWork.actualStartTime, endTime, inHydratedSubtree);
        var isViewTransitionEligible = (committedLanes & 335544064) === committedLanes;
        ...
        switch(finishedWork.tag){
            ...
            case 15:
                ...
                break;
            case 1:
                (finishedWork.mode & ProfileMode) !== NoMode && 0 < finishedWork.actualStartTime && (0 !== (finishedWork.flags & 128) ? logComponentErrored(finishedWork, finishedWork.actualStartTime, endTime, []) : 0 !== (finishedWork.flags & 1) && logComponentRender(finishedWork, finishedWork.actualStartTime, endTime, inHydratedSubtree));
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                break;
            case 3:
                ...
                isViewTransitionEligible && restoreRootViewTransitionName(finishedRoot.containerInfo);
            ...
            case 12:
                if (flags & 2048) {
                    ...
                    recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                    finishedRoot = finishedWork.stateNode;
                    finishedRoot.passiveEffectDuration += bubbleNestedEffectDurations(isViewTransitionEligible);
                    try {
            ...
            case 13:
                ...
                flags = null !== finishedWork.alternate ? finishedWork.alternate.memoizedState : null;
                prevEffectDuration = finishedWork.memoizedState;
                null === flags || null === flags.dehydrated || null !== prevEffectDuration && null !== prevEffectDuration.dehydrated ? inHydratedSubtree = !1 : (prevEffectDuration = finishedWork.deletions, null !== prevEffectDuration && 0 < prevEffectDuration.length && 18 === prevEffectDuration[0].tag ? (inHydratedSubtree = !1, flags = flags.hydrationErrors, null !== flags && logComponentErrored(finishedWork, finishedWork.actualStartTime, endTime, flags)) : inHydratedSubtree = !0);
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
            ...
            case 22:
                ...
                null !== finishedWork.memoizedState ? (isViewTransitionEligible && null !== wasInHydratedSubtree && null === wasInHydratedSubtree.memoizedState && restoreExitViewTransitions(wasInHydratedSubtree), prevEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : recursivelyTraverseAtomicPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime)) : (isViewTransitionEligible && null !== wasInHydratedSubtree && null !== wasInHydratedSubtree.memoizedState && restoreEnterViewTransitions(finishedWork), prevEffectDuration._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : (prevEffectDuration._visibility |= OffscreenPassiveEffectsConnected, recursivelyTraverseReconnectPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, 0 !== (finishedWork.subtreeFlags & 10256), endTime)));
                flags & 2048 && commitOffscreenPassiveMountEffects(wasInHydratedSubtree, finishedWork);
                break;
            case 24:
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                ...
                break;
            case 30:
                isViewTransitionEligible && (isViewTransitionEligible = finishedWork.alternate, null !== isViewTransitionEligible && 0 !== (finishedWork.subtreeFlags & 8246) && (finishedWork.memoizedState = null, restoreViewTransitionOnHostInstances(isViewTransitionEligible.child, !0), restoreViewTransitionOnHostInstances(finishedWork.child, !0)));
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                break;
            default:
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
    ...
    function recursivelyTraverseAtomicPassiveEffects(finishedRoot$jscomp$0, parentFiber, committedLanes$jscomp$0, committedTransitions$jscomp$0, endTime$jscomp$0) {
        if (parentFiber.subtreeFlags & 10256) for(var child = parentFiber.child; null !== child;){
            ...
            (child.mode & ProfileMode) !== NoMode && 0 < child.actualStartTime && 0 !== (child.flags & 1) && logComponentRender(child, child.actualStartTime, endTime, inHydratedSubtree);
    ...
    function commitPassiveUnmountEffectsInsideOfDeletedTree_begin(deletedSubtreeRoot, nearestMountedAncestor$jscomp$0) {
        for(; null !== nextEffect;){
            var fiber = nextEffect, current = fiber, nearestMountedAncestor = nearestMountedAncestor$jscomp$0, prevEffectStart = pushComponentEffectStart(), prevEffectErrors = pushComponentEffectErrors();
            switch(current.tag){
                case 0:
                case 11:
                case 15:
            ...
            (current.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && 0.05 < componentEffectDuration && logComponentEffect(current, componentEffectStartTime, componentEffectEndTime, componentEffectDuration, componentEffectErrors);
            popComponentEffectStart(prevEffectStart);
            componentEffectErrors = prevEffectErrors;
            current = fiber.child;
    ...
    function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
        ...
        if ("function" === typeof type) shouldConstruct(type) && (fiberTag = 1), resolvedType = resolveFunctionForHotReloading(resolvedType);
            ...
            case REACT_VIEW_TRANSITION_TYPE:
                return key = createFiber(30, pendingProps, key, mode), key.elementType = REACT_VIEW_TRANSITION_TYPE, key.lanes = lanes, key.stateNode = {
                    autoName: null,
                    paired: null,
                    ref: null
                }, key;
        ...
        for(parentFiber = parentFiber.child; null !== parentFiber;){
            switch(parentFiber.tag){
                ...
                case 6:
                    ...
                    if (null === clone) throw Error("This should have a text node initialized. This error is likely caused by a bug in React. Please file an issue.");
                ...
                case 4:
                    break;
                case 22:
                    null === parentFiber.memoizedState && recursivelyInsertClonesFromExistingTree(parentFiber, hostParentClone);
                    break;
                case 30:
    ...
    function recursivelyInsertClones(parentFiber, hostParentClone$jscomp$0) {
        if (null === parentFiber.alternate || 0 !== (parentFiber.subtreeFlags & 13878)) for(parentFiber = parentFiber.child; null !== parentFiber;){
            var finishedWork = parentFiber, hostParentClone = hostParentClone$jscomp$0, current = finishedWork.alternate, flags = finishedWork.flags;
            switch(finishedWork.tag){
                case 26:
                ...
                case 27:
                    recursivelyInsertClones(finishedWork, hostParentClone);
                    if (flags & 4) if (null === current) console.error("useSwipeTransition() caused something to render a new <%s>. This is not possible in the current implementation. Make sure that the swipe doesn't mount any new <%s> elements.", finishedWork.type, finishedWork.type);
                    else {
                ...
                case 5:
                    ...
                    null === current ? hostParentClone.appendChild(clone) : (null === finishedWork.child ? (clone = clone.cloneNode(!0), finishedWork.flags & 32 && resetTextContent(clone)) : clone = clone.cloneNode(!1), flags & 4 && commitUpdate(clone, finishedWork.type, current.memoizedProps, finishedWork.memoizedProps), unhideHostChildren ? (unhideHostChildren = !1, recursivelyInsertClones(finishedWork, clone), hostParentClone.appendChild(clone), unhideHostChildren = !0, unhideInstance(clone, finishedWork.memoizedProps)) : (recursivelyInsertClones(finishedWork, clone), hostParentClone.appendChild(clone)));
                    break;
                case 6:
                    clone = finishedWork.stateNode;
                    if (null === clone) throw Error("This should have a text node initialized. This error is likely caused by a bug in React. Please file an issue.");
                    null === current ? hostParentClone.appendChild(clone) : (clone = clone.cloneNode(!1), flags & 4 && (clone.nodeValue = current.memoizedProps), hostParentClone.appendChild(clone), unhideHostChildren && (clone.nodeValue = finishedWork.memoizedProps));
                    break;
                case 4:
                    break;
                case 22:
                    null === finishedWork.memoizedState && (unhideHostChildren = (current = unhideHostChildren) || 0 !== (flags & 8192), recursivelyInsertClones(finishedWork, hostParentClone), unhideHostChildren = current);
                    break;
                case 30:
        ...
        else recursivelyInsertClonesFromExistingTree(parentFiber, hostParentClone$jscomp$0);
    }
    ...
    function performWorkOnRoot(root, lanes, forceSync) {
        ...
        yieldDuration = (forceSync = !forceSync && 0 === (lanes & 124) && 0 === (lanes & root.expiredLanes) || checkIfRootIsPrerendering(root, lanes)) ? renderRootConcurrent(root, lanes) : renderRootSync(root, lanes, !0);
                ...
                if (yieldDuration === RootErrored) {
                    ...
                    if (0 !== errorRetryLanes) {
                        ...
                        a: {
                            ...
                            errorRetryLanes = renderRootSync(startTime, errorRetryLanes, !1);
                            if (errorRetryLanes !== RootErrored) {
                                ...
                                null !== startTime && (null === workInProgressRootRecoverableErrors ? workInProgressRootRecoverableErrors = startTime : workInProgressRootRecoverableErrors.push.apply(workInProgressRootRecoverableErrors, startTime));
                            }
                ...
                a: {
                    ...
                    switch(yieldDuration){
                        ...
                        case RootSuspendedAtTheShell:
                            ...
                            finalizeRender(lanes, startTime);
                            yieldEndTime = lanes;
                            0 !== (yieldEndTime & 3) || 0 !== (yieldEndTime & 124) ? blockingSuspendedTime = startTime : 0 !== (yieldEndTime & 4194048) && (transitionSuspendedTime = startTime);
    ...
    function commitRootWhenReady(root, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        if (isViewTransitionEligible || subtreeFlags & 8192 || 16785408 === (subtreeFlags & 16785408) || isGestureTransition) {
            ...
            if ((isViewTransitionEligible || isGestureTransition) && null === root.stoppingGestures) {
            ...
            if (null !== subtreeFlags) {
                root.cancelPendingCommit = subtreeFlags(commitRoot.bind(null, root, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, exitStatus, SUSPENDED_COMMIT, completedRenderStartTime, completedRenderEndTime));
                markRootSuspended(root, lanes, spawnedLane, !didSkipSuspendedSiblings);
                return;
            }
        }
        commitRoot(root, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime);
    }
    ...
    function finalizeRender(lanes, finalizationTime) {
        if (0 !== (lanes & 3) || 0 !== (lanes & 124)) blockingClampTime = finalizationTime;
    ...
    function prepareFreshStack(root, lanes) {
        ...
        if (0 !== workInProgressRootRenderLanes && 0 < previousRenderStartTime) {
            ...
            if (workInProgressRootExitStatus === RootSuspended || workInProgressRootExitStatus === RootSuspendedWithDelay) logSuspendedRenderPhase(previousRenderStartTime, renderStartTime, lanes);
            else {
                var endTime = renderStartTime;
                supportsUserTiming && (reusableLaneDevToolDetails.color = (lanes & 738197653) === lanes ? "tertiary-dark" : "primary-dark", reusableLaneOptions.start = previousRenderStartTime, reusableLaneOptions.end = endTime, performance.measure((lanes & 536870912) === lanes ? "Prewarm" : (lanes & 201326741) === lanes ? "Interrupted Hydration" : "Interrupted Render", reusableLaneOptions));
            }
        ...
        if (0 !== (lanes & 3) || 0 !== (lanes & 124)) {
            ...
            0 <= blockingSuspendedTime && (setCurrentTrackFromLanes(lanes), logSuspendedWithDelayPhase(blockingSuspendedTime, 0 <= endTime ? endTime : 0 <= previousRenderStartTime ? previousRenderStartTime : renderStartTime, lanes));
        ...
        if (0 !== endTime) for(root = root.entanglements, endTime &= lanes; 0 < endTime;)eventType = 31 - clz32(endTime), eventIsRepeat = 1 << eventType, lanes |= root[eventType], endTime &= ~eventIsRepeat;
    ...
    function commitRoot(root, finishedWork, lanes, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, exitStatus, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        if ((executionContext & (RenderContext | CommitContext)) !== NoContext) throw Error("Should not already be working.");
        setCurrentTrackFromLanes(lanes);
        exitStatus === RootErrored ? logErroredRenderPhase(completedRenderStartTime, completedRenderEndTime) : null !== recoverableErrors ? logRecoveredRenderPhase(completedRenderStartTime, completedRenderEndTime, lanes, recoverableErrors, null !== finishedWork && null !== finishedWork.alternate && finishedWork.alternate.memoizedState.isDehydrated && 0 !== (finishedWork.flags & 256)) : logRenderPhase(completedRenderStartTime, completedRenderEndTime, lanes);
        if (null === finishedWork) null !== root.stoppingGestures && stopCompletedGestures(root);
        else {
            ...
            if (64 === lanes) commitGestureOnRoot(root, finishedWork);
                ...
                (lanes & 335544064) === lanes ? (pendingTransitionTypes = ReactSharedInternals.V, ReactSharedInternals.V = null, recoverableErrors = 10262) : (pendingTransitionTypes = null, recoverableErrors = 10256);
                ...
                null !== root.stoppingGestures && (stopCompletedGestures(root), finishedWork = !1);
                pendingEffectsStatus = PENDING_MUTATION_PHASE;
                finishedWork && startViewTransition(root.containerInfo, pendingTransitionTypes, flushMutationEffects, flushLayoutEffects, flushAfterMutationEffects, flushSpawnedWork, flushPassiveEffects) || (flushMutationEffects(), flushLayoutEffects(), flushSpawnedWork());
            }
        }
    }
    ...
    function flushLayoutEffects() {
        if (pendingEffectsStatus === PENDING_LAYOUT_PHASE) {
            ...
            if (0 !== (finishedWork.subtreeFlags & 8772) || rootHasLayoutEffect) {
                ...
                executionContext |= CommitContext;
                try {
                    inProgressLanes = lanes, inProgressRoot = root, resetComponentEffectTimers(), commitLayoutEffectOnFiber(root, finishedWork.alternate, finishedWork), inProgressRoot = inProgressLanes = null;
                } finally{
    ...
    function flushSpawnedWork() {
        if (pendingEffectsStatus === PENDING_SPAWNED_WORK || pendingEffectsStatus === PENDING_AFTER_MUTATION_PHASE) {
            pendingEffectsStatus = NO_PENDING_EFFECTS;
            requestPaint();
            var root = pendingEffectsRoot, finishedWork = pendingFinishedWork, lanes = pendingEffectsLanes, completedRenderEndTime = pendingEffectsRenderEndTime, recoverableErrors = pendingRecoverableErrors, suspendedCommitReason = pendingSuspendedCommitReason;
            commitEndTime = now();
            ...
            null !== commitErrors ? logCommitErrored(completedRenderEndTime, suspendedCommitReason, commitErrors, !1) : supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-dark", reusableLaneOptions.start = completedRenderEndTime, reusableLaneOptions.end = suspendedCommitReason, performance.measure("Commit", reusableLaneOptions));
            completedRenderEndTime = (lanes & 335544064) === lanes ? 10262 : 10256;
            (completedRenderEndTime = 0 !== finishedWork.actualDuration || 0 !== (finishedWork.subtreeFlags & completedRenderEndTime) || 0 !== (finishedWork.flags & completedRenderEndTime)) ? pendingEffectsStatus = PENDING_PASSIVE_PHASE : (pendingEffectsStatus = NO_PENDING_EFFECTS, pendingFinishedWork = pendingEffectsRoot = null, releaseRootPooledCache(root, root.pendingLanes), nestedPassiveUpdateCount = 0, rootWithPassiveNestedUpdates = null);
            ...
            ensureRootIsScheduled(root);
            suspendedCommitReason = root.pendingLanes;
            0 !== (lanes & 4194090) && 0 !== (suspendedCommitReason & 42) ? (nestedUpdateScheduled = !0, root === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = root)) : nestedUpdateCount = 0;
    ...
    function commitGestureOnRoot(root, finishedWork) {
        ...
        if (null === finishedGesture) ensureRootIsScheduled(root);
            ...
            try {
                ...
                didWarnForRootClone || (didWarnForRootClone = !0, console.warn("useSwipeTransition() caused something to mutate or relayout the root. This currently requires a clone of the whole document. Make sure to add a <ViewTransition> directly around an absolutely positioned DOM node to minimize the impact of any changes caused by the Swipe Transition."));
                ...
                if (null === containerParent) throw Error("Cannot use a useSwipeTransition() in a detached root.");
                var clone = containerInstance.cloneNode(!1), computedStyle = getComputedStyle(containerInstance);
                if ("absolute" !== computedStyle.position && "fixed" !== computedStyle.position) {
                    for(rootContainer = containerParent; null != rootContainer.parentNode && 9 !== rootContainer.parentNode.nodeType && "static" === getComputedStyle(rootContainer).position;)rootContainer = rootContainer.parentNode;
                ...
                if ("none" !== rotate && "" !== rotate) {
                    ...
                    transform = 1 === _parts.length ? "rotate(" + _parts[0] + ") " + transform : 2 === _parts.length ? "rotate" + _parts[0].toUpperCase() + "(" + _parts[1] + ") " + transform : "rotate3d(" + _parts.join(", ") + ") " + transform;
                }
                var translate = computedStyle.translate;
                if ("none" !== translate && "" !== translate) {
                    var _parts2 = translate.split(" ");
                    transform = (3 === _parts2.length ? "translate3d" : "translate") + "(" + _parts2.join(", ") + ") " + transform;
                }
                var transform$jscomp$0 = transform;
                clone.style.translate = "none";
                clone.style.scale = "none";
                clone.style.rotate = "none";
                clone.style.transform = "translate(-20000px, -20000px) " + transform$jscomp$0;
            ...
            finishedGesture.running = startGestureTransition(root.containerInfo, finishedGesture.provider, finishedGesture.rangeCurrent, finishedGesture.direction ? finishedGesture.rangeNext : finishedGesture.rangePrevious, pendingTransitionTypes, flushGestureMutations, flushGestureAnimations);
        }
    }
    ...
    function flushPassiveEffects(wasDelayedCommit) {
        ...
        try {
            ...
            supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-light", reusableLaneOptions.start = startTime, reusableLaneOptions.end = endTime, performance.measure(wasDelayedCommit ? "Waiting for Paint" : "", reusableLaneOptions));
            ...
            null !== commitErrors ? logCommitErrored(finishedWork$jscomp$0, passiveEffectsEndTime, commitErrors, !0) : supportsUserTiming && (reusableLaneDevToolDetails.color = "secondary-dark", reusableLaneOptions.start = finishedWork$jscomp$0, reusableLaneOptions.end = passiveEffectsEndTime, performance.measure("Remaining Effects", reusableLaneOptions));
    ...
    function pingSuspendedRoot(root, wakeable, pingedLanes) {
        ...
        0 !== (pingedLanes & 3) || 0 !== (pingedLanes & 124) ? 0 > blockingUpdateTime && (blockingClampTime = blockingUpdateTime = now()) : 0 !== (pingedLanes & 4194048) && 0 > transitionUpdateTime && (transitionClampTime = transitionUpdateTime = now());
        ...
        if (!isFlushingWork && mightHavePendingSyncWork) {
            ...
            do {
                ...
                for(var root = firstScheduledRoot; null !== root;){
                    ...
                    } else nextLanes = workInProgressRootRenderLanes, nextLanes = getNextLanes(root, root === workInProgressRoot ? nextLanes : 0, null !== root.cancelPendingCommit || root.timeoutHandle !== noTimeout), 0 === (nextLanes & 3) && 64 !== nextLanes || checkIfRootIsPrerendering(root, nextLanes) || (didPerformSomeWork = !0, performSyncWorkOnRoot(root, nextLanes));
                    root = root.next;
                }
    ...
    function processRootScheduleInMicrotask() {
        ...
        for(var currentTime = now$1(), prev = null, root = firstScheduledRoot; null !== root;){
            ...
            else if (prev = root, 0 !== syncTransitionLanes || 0 !== (nextLanes & 3) || 64 === nextLanes) mightHavePendingSyncWork = !0;
            root = next;
        }
    ...
    function scheduleTaskForRootDuringMicrotask(root, currentTime) {
        ...
        if (0 !== (suspendedLanes & 3) && !checkIfRootIsPrerendering(root, suspendedLanes)) return null !== pingedLanes && cancelCallback(pingedLanes), root.callbackPriority = 2, root.callbackNode = null, 2;
    ...
    function fireScrollEnd(targetInst, nativeEvent, nativeEventTarget) {
        ...
        if (isMouseDown || isTouchStarted) debounceScrollEnd(targetInst, nativeEvent, nativeEventTarget);
        else {
            var dispatchQueue = [];
            targetInst = accumulateTwoPhaseListeners(targetInst, "onScrollEnd");
            0 < targetInst.length && (nativeEvent = new SyntheticUIEvent("onScrollEnd", "scrollend", null, nativeEvent, nativeEventTarget), dispatchQueue.push({
                event: nativeEvent,
    ...
    function debounceScrollEnd(targetInst, nativeEvent, nativeEventTarget) {
        ...
        null !== targetInst && (targetInst = setTimeout(fireScrollEnd.bind(null, targetInst, nativeEvent, nativeEventTarget), DEBOUNCE_TIMEOUT), nativeEventTarget[internalScrollTimer] = targetInst);
    }
        ...
        batchedUpdates$1(function() {
            ...
            a: {
                ...
                if (void 0 !== reactName) {
                    ...
                    inCapturePhase = accumulateSinglePhaseListeners(targetInst, reactName, nativeEvent.type, inCapturePhase, !inCapturePhase && ("scroll" === domEventName || "scrollend" === domEventName));
                ...
                a: {
                    ...
                    if (SyntheticEventCtor || reactName) {
                        ...
                        if (SyntheticEventCtor) {
                            if (reactEventType = nativeEvent.relatedTarget || nativeEvent.toElement, SyntheticEventCtor = targetInst, reactEventType = reactEventType ? getClosestInstanceFromNode(reactEventType) : null, null !== reactEventType) {
                                inCapturePhase = getNearestMountedFiber(reactEventType);
                                var tag = reactEventType.tag;
                                if (reactEventType !== inCapturePhase || 5 !== tag && 27 !== tag && 6 !== tag) reactEventType = null;
                            }
                        ...
                        if (SyntheticEventCtor !== reactEventType) {
                            ...
                            if ("pointerout" === domEventName || "pointerover" === domEventName) tag = SyntheticPointerEvent, leaveEventType = "onPointerLeave", enterEventType = "onPointerEnter", eventTypePrefix = "pointer";
                            inCapturePhase = null == SyntheticEventCtor ? reactName : getNodeFromInstance(SyntheticEventCtor);
                            var toNode = null == reactEventType ? reactName : getNodeFromInstance(reactEventType);
                            reactName = new tag(leaveEventType, eventTypePrefix + "leave", SyntheticEventCtor, nativeEvent, nativeEventTarget);
                            reactName.target = inCapturePhase;
                            reactName.relatedTarget = toNode;
                            leaveEventType = null;
                            getClosestInstanceFromNode(nativeEventTarget) === targetInst && (tag = new tag(enterEventType, eventTypePrefix + "enter", reactEventType, nativeEvent, nativeEventTarget), tag.target = toNode, tag.relatedTarget = inCapturePhase, leaveEventType = tag);
                            inCapturePhase = leaveEventType;
                            if (SyntheticEventCtor && reactEventType) b: {
                                tag = SyntheticEventCtor;
                                enterEventType = reactEventType;
                                eventTypePrefix = 0;
                                for(toNode = tag; toNode; toNode = getParent(toNode))eventTypePrefix++;
                                toNode = 0;
                                for(leaveEventType = enterEventType; leaveEventType; leaveEventType = getParent(leaveEventType))toNode++;
                                for(; 0 < eventTypePrefix - toNode;)tag = getParent(tag), eventTypePrefix--;
                                for(; 0 < toNode - eventTypePrefix;)enterEventType = getParent(enterEventType), toNode--;
                                for(; eventTypePrefix--;){
                                    if (tag === enterEventType || null !== enterEventType && tag === enterEventType.alternate) break b;
                                    tag = getParent(tag);
                            ...
                            null !== SyntheticEventCtor && accumulateEnterLeaveListenersForEvent(dispatchQueue, reactName, SyntheticEventCtor, tag, !1);
                            null !== reactEventType && null !== inCapturePhase && accumulateEnterLeaveListenersForEvent(dispatchQueue, inCapturePhase, reactEventType, tag, !0);
                        }
                    }
                }
                a: {
            ...
            a: if (fallbackData = 0 !== (eventSystemFlags & 4), "scrollend" !== domEventName) {
                if (!isScrollEndEventSupported && fallbackData) switch(domEventName){
                    case "scroll":
                ...
                if (!isScrollEndEventSupported && null !== nativeEventTarget) if (eventType = nativeEventTarget[internalScrollTimer], null != eventType) clearTimeout(eventType), nativeEventTarget[internalScrollTimer] = void 0;
                else break a;
                targetInst = accumulateSinglePhaseListeners(targetInst, "onScrollEnd", "scrollend", fallbackData, !fallbackData);
                0 < targetInst.length && (nativeEventTarget = new SyntheticUIEvent("onScrollEnd", "scrollend", null, nativeEvent, nativeEventTarget), dispatchQueue.push({
    ...
    function accumulateSinglePhaseListeners(targetFiber, reactName, nativeEventType, inCapturePhase, accumulateTargetOnly) {
        ...
        for(nativeEventType = []; null !== targetFiber;){
            ...
            5 !== _instance2 && 26 !== _instance2 && 27 !== _instance2 || null === inCapturePhase || null === reactName || (_instance2 = getListener(targetFiber, reactName), null != _instance2 && nativeEventType.push(createDispatchListener(targetFiber, _instance2, inCapturePhase)));
    ...
    function setProp(domElement, tag, key, value, props, prevValue) {
        switch(key){
            ...
            case "onScroll":
                ...
                return;
            case "onScrollEnd":
                null != value && ("function" !== typeof value && warnForInvalidEventListener(key, value), listenToNonDelegatedEvent("scrollend", domElement), listenToNonDelegatedEvent("scroll", domElement));
                return;
            case "dangerouslySetInnerHTML":
                if (null != value) {
        ...
        try {
            var transition = ownerDocument.startViewTransition({
                update: function() {
                    ...
                    mutationCallback();
                    if ("loaded" === previousFontLoadingStatus && (ownerDocument.documentElement.clientHeight, "loading" === ownerDocument.fonts.status)) return previousFontLoadingStatus = Promise.race([
                    ...
                    layoutCallback();
                    if (ownerWindow) return ownerWindow.finished.then(afterMutationCallback, afterMutationCallback);
            ...
            transition.ready.then(void 0, function(reason) {
                "object" === typeof reason && null !== reason && "TimeoutError" === reason.name && console.error("A ViewTransition timed out because a Navigation stalled. This can happen if a Navigation is blocked on React itself. Such as if it's resolved inside useEffect. This can be solved by moving the resolution to useLayoutEffect.");
            });
    ...
    function mergeTranslate(translateA, translateB) {
        ...
        var i, result = "";
        for(i = 0; i < translateA.length && i < translateB.length; i++)0 < i && (result += " "), result += "calc(" + translateA[i] + " + " + translateB[i] + ")";
    ...
    function animateGesture(keyframes, targetElement, pseudoElement, timeline, rangeStart, rangeEnd, moveFirstFrameIntoViewport, moveAllFramesIntoViewport) {
        for(var i = 0; i < keyframes.length; i++){
            ...
            if (moveAllFramesIntoViewport && null == keyframe.transform) if (null == keyframe.translate || "" === keyframe.translate) {
            ...
            } else keyframe.translate = mergeTranslate(keyframe.translate, "20000px 20000px");
        }
    ...
    function startGestureTransition(rootContainer, timeline, rangeStart, rangeEnd, transitionTypes, mutationCallback, animateCallback) {
        var ownerDocument = 9 === rootContainer.nodeType ? rootContainer : rootContainer.ownerDocument;
        try {
            var transition = ownerDocument.startViewTransition({
            ...
            var readyCallback = function() {
                for(var documentElement = ownerDocument.documentElement, animations = documentElement.getAnimations({
                    subtree: !0
                }), foundGroups = new Set(), foundNews = new Set(), i = 0; i < animations.length; i++){
                    var pseudoElement = animations[i].effect.pseudoElement;
                    null != pseudoElement && (pseudoElement.startsWith("::view-transition-group") ? foundGroups.add(pseudoElement.slice(23)) : pseudoElement.startsWith("::view-transition-new") && foundNews.add(pseudoElement.slice(21)));
                }
                for(i = 0; i < animations.length; i++){
                    var anim = animations[i];
                    pseudoElement = anim.effect;
                    var _pseudoElement = pseudoElement.pseudoElement;
                    if (null != _pseudoElement && _pseudoElement.startsWith("::view-transition")) {
                        anim.cancel();
                        var isGeneratedGroupAnim = !1, isExitGroupAnim = !1;
                        if (_pseudoElement.startsWith("::view-transition-group")) {
                            var groupName = _pseudoElement.slice(23);
                            foundNews.has(groupName) ? (anim = anim.animationName, isGeneratedGroupAnim = null != anim && anim.startsWith("-ua-view-transition-group-anim-")) : isExitGroupAnim = !0;
                        }
                        animateGesture(pseudoElement.getKeyframes(), pseudoElement.target, _pseudoElement, timeline, rangeStart, rangeEnd, isGeneratedGroupAnim, isExitGroupAnim);
                        _pseudoElement.startsWith("::view-transition-old") && (_pseudoElement = _pseudoElement.slice(21), foundGroups.has(_pseudoElement) || foundNews.has(_pseudoElement) || (foundGroups.add(_pseudoElement), animateGesture([
                            {},
                            {}
                        ], pseudoElement.target, "::view-transition-group" + _pseudoElement, timeline, rangeStart, rangeEnd, !1, !0)));
                    }
                }
            ...
            transition.finished.then(function() {
                for(var animations = ownerDocument.documentElement.getAnimations({
                    ...
                    var anim = animations[i], pseudo = anim.effect.pseudoElement;
                    null != pseudo && pseudo.startsWith("::view-transition") && anim.cancel();
                }
                ownerDocument.__reactViewTransition === transition && (ownerDocument.__reactViewTransition = null);
            });
            return transition;
    ...
    function getCurrentGestureOffset(provider) {
        ...
        if (null === provider) throw Error("Cannot start a gesture with a disconnected AnimationTimeline.");
        return "number" === typeof provider ? provider : provider.value;
    }
    function subscribeToGestureDirection(provider, currentOffset, directionCallback) {
        function rafCallback() {
            var newTime = provider.currentTime;
            null !== newTime && (newTime = "number" === typeof newTime ? newTime : newTime.value, newTime !== currentOffset && directionCallback(newTime > currentOffset));
            callbackID = requestAnimationFrame(rafCallback);
        }
        if ("function" === typeof ScrollTimeline && provider instanceof ScrollTimeline) {
            var element = provider.source, scrollCallback = function() {
                var newTime = provider.currentTime;
                null !== newTime && (newTime = "number" === typeof newTime ? newTime : newTime.value, newTime !== currentOffset && directionCallback(newTime > currentOffset));
            };
    ...
    "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
    var Scheduler = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/scheduler-experimental/index.js [app-client] (ecmascript)"), React = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react-experimental/index.js [app-client] (ecmascript)"), ReactDOM = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/react-dom-experimental/index.js [app-client] (ecmascript)"), assign = Object.assign, REACT_LEGACY_ELEMENT_TYPE = Symbol.for("react.element"), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler"), REACT_PROVIDER_TYPE = Symbol.for("react.provider"), REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy");
    ...
    var index$jscomp$0 = -1, contextStackCursor = createCursor(null), contextFiberStackCursor = createCursor(null), rootInstanceStackCursor = createCursor(null), hostTransitionProviderCursor = createCursor(null), hasOwnProperty = Object.prototype.hasOwnProperty, scheduleCallback$3 = Scheduler.unstable_scheduleCallback, cancelCallback$1 = Scheduler.unstable_cancelCallback, shouldYield = Scheduler.unstable_shouldYield, requestPaint = Scheduler.unstable_requestPaint, now$1 = Scheduler.unstable_now, getCurrentPriorityLevel = Scheduler.unstable_getCurrentPriorityLevel, ImmediatePriority = Scheduler.unstable_ImmediatePriority, UserBlockingPriority = Scheduler.unstable_UserBlockingPriority, NormalPriority$1 = Scheduler.unstable_NormalPriority, LowPriority = Scheduler.unstable_LowPriority, IdlePriority = Scheduler.unstable_IdlePriority, log$1 = Scheduler.log, unstable_setDisableYieldValue = Scheduler.unstable_setDisableYieldValue, rendererID = null, injectedHook = null, hasLoggedError = !1, isDevToolsPresent = "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__, clz32 = Math.clz32 ? Math.clz32 : clz32Fallback, log = Math.log, LN2 = Math.LN2, nextTransitionLane = 256, nextRetryLane = 4194304, DiscreteEventPriority = 2, ContinuousEventPriority = 8, DefaultEventPriority = 32, IdleEventPriority = 268435456, randomKey = Math.random().toString(36).slice(2), internalInstanceKey = "__reactFiber$" + randomKey, internalPropsKey = "__reactProps$" + randomKey, internalContainerInstanceKey = "__reactContainer$" + randomKey, internalEventHandlersKey = "__reactEvents$" + randomKey, internalEventHandlerListenersKey = "__reactListeners$" + randomKey, internalEventHandlesSetKey = "__reactHandles$" + randomKey, internalRootNodeResourcesKey = "__reactResources$" + randomKey, internalHoistableMarker = "__reactMarker$" + randomKey, internalScrollTimer = "__reactScroll$" + randomKey, allNativeEvents = new Set(), registrationNameDependencies = {}, possibleRegistrationNames = {}, hasReadOnlyValue = {
        ...
        reset: !0,
        submit: !0
    }, VALID_ATTRIBUTE_NAME_REGEX = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), illegalAttributeNameCache = {}, validatedAttributeNameCache = {}, viewTransitionMutationContext = !1, disabledDepth = 0, prevLog, prevInfo, prevWarn, prevError, prevGroup, prevGroupCollapsed, prevGroupEnd;
    ...
    var ANIMATION_END = getVendorPrefixedEventName("animationend"), ANIMATION_ITERATION = getVendorPrefixedEventName("animationiteration"), ANIMATION_START = getVendorPrefixedEventName("animationstart"), TRANSITION_RUN = getVendorPrefixedEventName("transitionrun"), TRANSITION_START = getVendorPrefixedEventName("transitionstart"), TRANSITION_CANCEL = getVendorPrefixedEventName("transitioncancel"), TRANSITION_END = getVendorPrefixedEventName("transitionend"), topLevelEventsToReactNames = new Map(), simpleEventPluginEvents = "abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" "), CapturedStacks = new WeakMap(), OffscreenVisible = 1, OffscreenDetached = 2, OffscreenPassiveEffectsConnected = 4, concurrentQueues = [], concurrentQueuesIndex = 0, concurrentlyUpdatedLanes = 0, emptyContextObject = {};
    ...
    ReactSharedInternals.S = function(transition, returnValue) {
        if ("object" === typeof returnValue && null !== returnValue && "function" === typeof returnValue.then) {
            if (0 > transitionStartTime && 0 > transitionUpdateTime) {
                ...
                if (newEventTime !== transitionEventTime || newEventType !== transitionEventType) transitionEventIsRepeat = !1;
    ...
    var renderLanes = 0, currentlyRenderingFiber = null, currentHook = null, workInProgressHook = null, didScheduleRenderPhaseUpdate = !1, didScheduleRenderPhaseUpdateDuringThisPass = !1, shouldDoubleInvokeUserFnsInHooksDEV = !1, localIdCounter = 0, thenableIndexCounter$1 = 0, thenableState$1 = null, globalClientIdCounter$1 = 0, RE_RENDER_LIMIT = 25, currentHookNameInDev = null, hookTypesDev = null, hookTypesUpdateIndexDev = -1, ignorePreviousDependencies = !1, ContextOnlyDispatcher = {
    ...
    var fakeActCallbackNode$1 = {}, firstScheduledRoot = null, lastScheduledRoot = null, didScheduleMicrotask = !1, didScheduleMicrotask_act = !1, mightHavePendingSyncWork = !1, isFlushingWork = !1, currentEventTransitionLane = 0, fakeActCallbackNode = {}, isScrollEndEventSupported = canUseDOM && isEventSupported("scrollend"), isTouchStarted = !1, isMouseDown = !1, DEBOUNCE_TIMEOUT = 200;
    (function() {
    ...
    registerTwoPhaseEvent("onScrollEnd", "scroll scrollend touchstart touchcancel touchend mousedown mouseup".split(" "));
    ...
    (function() {
        ...
        if ("19.1.0-experimental-029e8bd6-20250306" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.1.0-experimental-029e8bd6-20250306\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
...
"[project]/node_modules/next/dist/compiled/react-dom-experimental/client.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
//# sourceMappingURL=node_modules_next_dist_compiled_react-dom-experimental_375bf58e._.js.map