...
const OverlayDragPreview = (t0)=>{
    ...
    let t15;
    $[24] !== t1 || $[25] !== theme.color.skeleton.from ? (t15 = t1.map((r_1, i)=>/* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])("rect", {
            x: r_1.x,
            y: r_1.y,
            width: r_1.w,
            height: r_1.h,
